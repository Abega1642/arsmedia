package dev.razafindratelo.arsmedia.event.config;
...
import dev.razafindratelo.arsmedia.config.JacksonConfiguration;
...
public class InfraEventTypeRegistrar implements JacksonConfiguration.PolymorphicTypeRegistrar {

  private static final String EVENT_BASE_PACKAGE = "dev.razafindratelo.arsmedia.event";
